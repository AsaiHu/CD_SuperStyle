...
namespace Utilities
{
    public class Network
    {
        ...
        /// <returns></returns>
        public static string GetWebRoot(HttpContextBase context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public static string GetWebRoot(Page page)
        {
        ...
        public static string Get(string url, string[] key, string[] value, ILog logger)
        {
            try
            {
